...
sample_cov <- matrix( c(4.01080729, 0.723002998151, 0.709007629876, 10.311646515156,
  8.48659986384, 0.723002998151, 0.39025009, 0.231917338718, 3.390174597222, 1.95375374784,
  0.709007629876, 0.231917338718, 0.33616804, 2.674291111752, 2.476723403648, 10.311646515156,
  3.390174597222, 2.674291111752, 56.76416964, 30.418914201216, 8.48659986384, 1.95375374784,
  2.476723403648, 30.418914201216, 41.41179904), nrow = 5L)
rownames(sample_cov) <- c("SP_A", "SP_L", "IQ_A", "IQ_L", "ADVICE")
colnames(sample_cov) <- rownames(sample_cov)
object <- try(sem(
sample.cov = sample_cov, sample.nobs = 276, likelihood = 'wishart', model = Model
), outFile = stdout())
