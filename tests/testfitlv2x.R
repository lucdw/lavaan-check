...
Data <- read.csv("testfitlv2x_dat01.csv")
...
Data.missing <- read.csv("testfitlv2x_dat02.csv")
...
Data.binary <- read.csv("testfitlv2x_dat03.csv")
...
#     idx <- sample(1:length(x), missing.per.var); x[idx] <- NA; x}))
Data.missing <- read.csv("testfitlv2x_dat04.csv")
